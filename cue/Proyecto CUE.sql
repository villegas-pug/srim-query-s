...
SELECT COUNT(1) FROM SimPersona sper -- 30,885,317
WHERE 
	...
	-- AND (sper.sIdPaisNacionalidad NOT IN ('NNN', '') AND sper.sIdPaisNacionalidad IS NOT NULL)
	-- AND (sper.sIdPaisNacimiento NOT IN ('NNN', 'PER', '') AND sper.sIdPaisNacimiento IS NOT NULL)
...
-- Test ...
SELECT TOP 1000 * FROM #tmp_simextranjero

-- Index's ...
CREATE NONCLUSTERED INDEX IX_tmp_simextranjero_uIdPersona
    ON dbo.#tmp_simextranjero(uIdPersona)

CREATE NONCLUSTERED INDEX IX_tmp_simextranjero_sNombre_sPaterno_sMaterno_sSexo_dFechaNacimiento_sIdPaisNacionalidad
    ON dbo.#tmp_simextranjero(sNombre, sPaterno, sMaterno, sSexo, dFechaNacimiento, sIdPaisNacionalidad)

CREATE NONCLUSTERED INDEX IX_tmp_simextranjero_sNombre_sPaterno_sMaterno_sSexo_dFechaNacimiento_sIdPaisNacimiento
    ON dbo.#tmp_simextranjero(sNombre, sPaterno, sMaterno, sSexo, dFechaNacimiento, sIdPaisNacimiento)
...
FROM (
	...
	FROM (
		...
		SELECT 
			e.*	
		FROM #tmp_simextranjero e
		JOIN #tmp_simextranjero ee ON LEN(e.sNombre) != LEN(ee.sNombre)
