...
/*
   | Motivo de Alerta | observaciones de la Alerta | Fecha Emisión Alerta | Fecha Recepción Alerta |
   | Fecha Registro Alerta | Tipo de Documento | N° de Documento | Observaciones de la alerta migratoria | otros
*/

DROP TABLE IF EXISTS #dnv_informativas_inhabilitada
SELECT
   [Motivo Alerta] = smi.sDescripcion,
   [Fecha Emisión] = sdi.dFechaEmision,
   [Fecha Recepción] = sdi.dFechaRecepcion,
   [Documento Invalida] = sdi.sIdDocInvalida,
   [Número Documento Invalida] = sdi.sNumDocInvalida,
   [Tipo Alerta] = stt.sDescripcion,
   [Observaciones] = sdi.sObservaciones,
...
-- Test 
SELECT * FROM #dnv_informativas_inhabilitada
