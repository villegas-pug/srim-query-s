...
-- 2. Extranjeros regulares con direcciones incongruentes ...
-- ======================================================================================================================================================================== */
...
-- 3. Extranjeros con Calidad Migratoria `TURISTA` sin nacionalidad ...
-- ======================================================================================================================================================================== */
...
SELECT
   ...
   -- Aux
   [Id Modulo Registro] = s.sIdModulo,
   [Nombre Módulo Registro] = m.sNombre
...
WHERE
   ...
   AND (p.sIdPaisNacionalidad = 'NNN' OR p.sIdPaisNacionalidad IS NULL)
-- ======================================================================================================================================================================== */
